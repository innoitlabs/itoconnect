...
class ColorResources {
  ...
  static Color getDarkGrey(BuildContext context) {
    return Provider.of<ThemeProvider>(context).darkTheme ? const Color(0xFF678cb5) : const Color(0xFF737373);
  }

  static Color getDividerGrey(BuildContext context) {
    return Provider.of<ThemeProvider>(context).darkTheme ? const Color(0xFFABABAB) : const Color(0xFFABABAB);
  }

  static Color getTabTitleGrey(BuildContext context) {
    return Provider.of<ThemeProvider>(context).darkTheme ? const Color(0xFF484848) : const Color(0xFF484848);
  }
