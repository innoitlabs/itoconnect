    ...
    return Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('Please Login First', textAlign: TextAlign.center, style: titilliumSemiBold.copyWith(fontSize: height*0.017)),
            SizedBox(height: height*0.05),
            Padding(
            ...
            InkWell(
              ...
              child: Padding(
                ...
                child: Text('Create New Account', style: titilliumRegular.copyWith(
