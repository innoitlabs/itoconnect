...
import 'package:i2connect/provider/product_provider.dart';
import 'package:i2connect/provider/search_provider.dart';
            ...
            InkWell(
              onTap: (){
                if(controller.text.trim().isNotEmpty) {
                  ...
                  showCustomSnackBar('enter somethings', context);
