...
class ListFullScreen extends StatefulWidget {
  ...
  const ListFullScreen({Key? key, this.screenType = '', this.importantPeopleList}) : super(key: key);
          ...
          Column(
            children: [
              ...
              Container(
                ...
                child: widget.screenType == 'ImportantPeople' ? ImportantPeople(isDashboard: false, importantPeopleList: widget.importantPeopleList!,) : WardIssues(isDashboard: false),
              ),
            ],
          ),
        ],
